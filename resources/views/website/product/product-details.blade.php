                        ...
                        <div class="tab-content nav-material" id="top-tabContent">
                            ...
                            <div class="tab-pane fade" id="top-review" role="tabpanel" aria-labelledby="review-top-tab">
                                        ...
                                        <div class="col mt-3">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    @if($review->customer->image != null)
                                                        <img src="{{ asset($review->customer->image) }}" class="rounded-circle" width="80" height="80" alt="Profile Image">
                                                    @else
                                                        <img src="https://picsum.photos/200/300.jpg" class="rounded-circle" width="80" height="80" alt="Sample Image">
                                                    @endif
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <h5>{{ $review->customer->name }}<small class="text-muted"><i> Posted on {{ $review->created_at }}</i></small></h5>
                                                    <p class="ms-0">{{ $review->review }}.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if (Session('customer_id'))
                                    <form action="{{ route('product-review',$product->id) }}" class="theme-form" method="POST">
                                        @csrf
                                        <div class="row mt-2">
                                            <div class="col-md-12">
                                                <label>Review </label>
                                                <textarea class="form-control" name="review" placeholder="Wrire Your Testimonial Here" id="exampleFormControlTextarea1" rows="6"></textarea>
                                            </div>
                                            <div class="col-md-12">
                                ...
                                @else
                                    <ul class="cart_total mt-3">
                                        <li>
                                            <div class="buttons">
                                                <a href="{{ route('customer.login') }}" class="btn btn-solid btn-block btn-md">Please Login</a>
                                            </div>
                                        </li>
                                    </ul>
                                @endif
