                ...
                <div class="col">
                    <div class="breadcrumb-contain">
                        <div>
                            <h2>Offer</h2>
                                <ul>
                                    <li><a href="">Offer Product</a></li>
                                    <li><i class="fa fa-angle-double-right"></i></li>
                                    <li><a href="javascript:void(0)">All Product Offer</a></li>
                                </ul>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="product-box">
                                                            <div class="product-imgbox">
                                                                <div class="product-front">
                                                                    <a href="{{ route('product.details',['id'=>$offerDetail->product->id]) }}"> <img src="{{ asset($offerDetail->product->image) }}" class="img-fluid  " alt="product"> </a>
                                                                </div>
                                                            ...
                                                            <div class="product-detail detail-center detail-inverse">
                                                                <div class="detail-title">
                                                                    ...
                                                                    <div class="detail-right">
                                                                        @if($offerDetail->product->discount_amount )
                                                                            <div class="check-price"> BDT.{{ round($offerDetail->product->regular_price) }}</div>
                                                                            <div class="price">
                                                                                <div class="price"> BDT.{{ $offerDetail->product->selling_price }}</div>
                                                                            </div>
                                                                        @else
                                                                            <div class="price">
                                                                                <div class="price"> {{ $offerDetail->product->regular_price }}</div>
                                                                            </div>
