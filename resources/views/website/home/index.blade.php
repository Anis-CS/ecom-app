                                    ...
                                    <div class="slide-main">
                                        ...
                                        <div class="slide-contain">
                                            <div>
                                                <h4>all product</h4>
                                                <h2>{{ $offer->name }}</h2>
                                                <h3>save up to {{ $offer->percentage }}% off</h3>
                            ...
                            <div class="collection-banner-main banner-17 banner-style7 collection-color14 p-left text-center">
                                ...
                                <div class="collection-banner-contain ">
                                    <div>
                                        ...
                                        <h4>best choise {{ $offer_two_product['percentage'] }}</h4>
                        ...
                        <div class="product-box product-box2">
                            ...
                            <div class="product-detail product-detail2 ">
                                ...
                                @if($product->selling_price <= 0)
                                    <h5>
                                        <b class="fw-bold">&#2547;</b>{{ number_format(round($product->regular_price)) }}
                                    </h5>
                                @else
                                    <h5>
                                        <b class="fw-bold">&#2547;</b>{{ number_format(round($product->selling_price)) }}
                                        <b class="fw-bold">&#2547;</b><span>{{ number_format(round($product->regular_price)) }}</span>
                                    </h5>
                                @endif
...
<section class="collection-banner section-py-space b-g-white">
    <div class="container-fluid">
        <div class="row collection-p4">
            @foreach($combo_offors as $combo_offor)
                    <div class="col-md-4">
                        <div class="collection-banner-main p-center text-center p-top banner-16 banner-style7">
                            <div class="collection-img">
                                <img src="{{asset($combo_offor->image)}}" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>{{ $combo_offor->name }}</h3>
                                    <h4>Save up to {{$combo_offor->percentage}}% discount</h4>
                                    <a href="{{ route('product-offer', ['id'=>$combo_offor->id]) }}" class="btn btn-rounded btn-xs"> Shop Now </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@foreach($hotoffers as $hotoffer)
    <section class="sale-banenr banner-style2  section-big-mb-space">
        <img src="{{asset($hotoffer->image)}}" alt="sale-banenr" class="img-fluid bg-img">
        <div class="custom-container">
            <div class="row">
                <div class="col-12 position-relative">
                    <div class="sale-banenr-contain text-center  p-right">
                        <div>
                            <h4>summer sale {{ $hotoffer->percentage }}% off</h4>
                            <h2>{{ $hotoffer->name }}</h2>
                            @foreach($hotoffer->offerDetails as $offerProduct)
                                <h4>{{ $offerProduct->product->name }}</h4>
                            @endforeach
                            <a href="{{ route('product-offer', ['id'=>$hotoffer->id]) }}" class="btn btn-rounded">Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
