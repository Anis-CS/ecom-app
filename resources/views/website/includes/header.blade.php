                            ...
                            <div class="menu-block">
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <!--SHOP-END-->
                                        <!--product-meu start-->
                                        <li class="mega"><a class="dark-menu-item" href="{{ route('shipping-policy') }}">Shipping Policy</a>
                                        </li>
                                        <!--product-meu end-->
                                        ...
                                        <!--pages meu start-->
                                        <li>
                                            <a class="dark-menu-item" href="{{ route('terms-and-condition-policy') }}">Terns $ Condition</a>
                                        </li>
                                        <!--product-end end-->
