        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">All Product Review</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Tables</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Manage Review</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                        ...
                                        @foreach($reviews as $review)
                                            <tr>
                                                ...
                                                <td class="justify-content-center">
                                                    <a href="{{ route('update-review-status',['id'=> $review->id]) }}" class="btn btn-primary btn-sm me-2 float-start {{ $review->status == 1 ? 'bg-success' : 'btn-warning' }}">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <form action="{{ route('delete-review', ['id'=> $review->id] ) }}" method="post">
                                                        @csrf
