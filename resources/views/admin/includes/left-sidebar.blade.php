            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('couriers.index') }}" class="slide-item">Courier Info</a></li>
                        <li><a href="{{ route('privacy-policy.index') }}" class="slide-item">Privacy Policy</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('offers.index') }}" class="slide-item">Manage Offers</a></li>
